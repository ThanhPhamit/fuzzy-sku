...
AWS Lambda function that uses Bedrock Claude Sonnet 4.5 to re-rank OpenSearch results for Japanese SKU search.
...
| ---------------------- | ---------------------------------- | ------------------------------------------- |
| `AWS_REGION`           | `ap-northeast-3`                   | AWS region for Bedrock client               |
